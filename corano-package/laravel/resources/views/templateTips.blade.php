                     ...
                     <div class="collapse navbar-collapse scroll-nav">
                        <ul class="navbar-nav navbar-mobile navbar_left  ml-auto" id="nav">
                           <li class="nav-item nav-item">
                              <a class="nav-link link_hd" href="/index">  Home  </a>
                           </li>
                  ...
                  <div class="row">
                     <div class="col-lg-6">
                        <div class="heading  tp_one">
                           <h6>TIPS DAN TRICK</h6>
                           <h1>Penyakit Coronavirus 2019 (COVID-19)</h1>
                           <span class="flaticon-virus icon"></span>
                        </div>
                        <div class="about_content">
                           <p class="description">Virus Corona atau severe acute respiratory syndrome coronavirus 2 (SARS-CoV-2) adalah virus yang menyerang sistem pernapasan. Penyakit karena infeksi virus ini disebut COVID-19. Virus Corona bisa menyebabkan gangguan ringan pada sistem pernapasan, infeksi paru-paru yang berat, hingga kematian.
                           </p>
                           <div class="symptoms">
                              <h2>Cara terbaik untuk mencegah penyakit adalah menghindari virus ini.</h2>
                              <div class="row">
                                 <div class="col-lg-6">
                                    <ul>
                                       <li>
                                          <span class="flaticon-check"></span>
                                          <p>Bersihkan dengan memberi disinfeksi ke permukaan yang sering disentuh</p>
                                       </li>
                                       <li>
                                          <span class="flaticon-check"></span>
                                       ...
                                       <li>
                                          <span class="flaticon-check"></span>
                                          <p>Bersihkan tangan Anda dengan pembersih tangan/hand sanitizer</p>
                                       </li>
                                       <li>
                                          <span class="flaticon-check"></span>
                                          <p>Tutup mulut ketika batuk dan bersin</p>
                                       </li>
                                    </ul>
                                 </div>
                                 <div class="col-lg-6">
                                    <ul>
                                       <li>
                                          <span class="flaticon-check"></span>
                                          <p>Tetap di rumah jika anda sakit</p>
                                       </li>
                                       <li>
                                          <span class="flaticon-check"></span>
                                          <p>Kenakan masker jika sakit</p>
                                       </li>
                                       <li>
                                          <span class="flaticon-check"></span>
                                          <p>Tutup mulut dan hidung anda</p>
                                       </li>
                                       <li>
                                          <span class="flaticon-check"></span>
                                          <p>Buang tisu bekas ke tempat sampah</p>
                                       </li>
                                       <li>
                                          <span class="flaticon-check"></span>
                                          <p>Pastikan larutan mengandung setidaknya 70% alkohol.</p>
                                       </li>
                                    </ul>
                                 </div>
                              </div>
                           ...
                           <div class="col-lg-6 first_column">
                              <div class="icon_box type_one wow slideInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                 ...
                                 <div class="content_box">
                                    <h2><a href="#">Tinggal di rumah</a></h2>
                                    <p>Karantina mandiri dengan cara berdiam diri di rumah masing-masing.</p>
                                 </div>
                              </div>
                              <div class="icon_box type_one wow slideInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                 <div class="icon">
                                 ...
                                 <div class="content_box">
                                    ...
                                    <p>Lindungi diri anda sendiri dengan menggunakan masker dan semua perlengkapan.</p>
                                 </div>
                              </div>
                           </div>
                           <div class="col-lg-6 second_column">
                              <div class="icon_box type_one wow slideInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                                 ...
                                 <div class="content_box">
                                    ...
                                    <p>Dengan saling berpegang tangan bersama sama, adalah salah satu cara terbaik untuk menghancurkan virus ini.</p>
                                 </div>
                              </div>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="heading icon_dark text-center tp_one">
                           <h6>Penyebaran Virus</h6>
                           <h1>Bagaimana penyebaran virus?</h1>
                           <span class="flaticon-virus icon"></span>
                           <p>Virus ini menular dengan sangat cepat dan telah menyebar ke hampir semua negara, termasuk Indonesia, hanya dalam waktu beberapa bulan.</p>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-lg-12 padding_zero">
                        <div class="owl-carousel three_items_center">
                           <div class="spreading_box type_one">
                              ...
                              <div class="content_box">
                                 <h2>
                                    <a href="#">Dari kontak dengan orang yag terinfeksi</a>
                                 </h2>
                                 <p>Kontak langsung dengan orang yang terinfeksi menjadi salah satu penyebab terjadinya penyebaran coronavirus.</p>
                           ...
                           <div class="spreading_box type_one">
                              ...
                              <div class="content_box">
                                 <h2>
                                    <a href="#">Tetesan dari batuk atau bersin orang yang terinfeksi</a>
                                 </h2>
                                 <p>Tetesan batuk atau bersin bisa menjadi penyebab penyeberan virus ini.</p>
                                 <a href="#" class="read_more tp_one">Read More <span class="flaticon-next"></span></a>
                              </div>
                           </div>
                           <div class="spreading_box type_one">
                              ...
                              <div class="content_box">
                                 <h2>
                                    <a href="#">Menyentuh benda yang memiliki tetesan bersin atau batuk</a>
                                 </h2>
                                 <p>Benda yang memilki tetesan bersin atau batuk bisa menjadi penyebab penyebaran coronavirus.</p>
                                 <a href="#" class="read_more tp_one">Read More <span class="flaticon-next"></span></a>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="heading tp_one text-center">
                           <h6>GEJALA</h6>
                           <h1>Perhatikan Gejalanya!</h1>
                           <span class="flaticon-virus icon"></span>
                           <p>Coronavirus dapat menimbulkan gejala ringan hingga gejala berat, dan bisa juga tidak menimbulkan gejala.</p>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="heading text-center tp_one">
                           <h6>Pencegahan Coronavirus</h6>
                           <h1>Cara terbaik mencegah Coronavirus</h1>
                           <span class="flaticon-virus icon"></span>
                           <p>Lebih baik mencegah dibanding mengobati.</p>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-lg-3">
                        <div class="icon_box type_two wow fadeIn" data-wow-delay="00ms" data-wow-duration="1500ms">
                           <h2><a href="prevention-single.html">Sering mencuci tangan dengan sabun</a></h2>
                           <div class="icon_box">
                     ...
                     <div class="col-lg-3">
                        <div class="icon_box type_two wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                           <h2><a href="prevention-single.html">Hindari menyentuh mata, hidung, dan mulut anda</a></h2>
                           <div class="icon_box">
                     ...
                     <div class="col-lg-3">
                        <div class="icon_box type_two wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                           <h2><a href="prevention-single.html">Hindari kontak dekat dengan orang yang sakit</a></h2>
                           <div class="icon_box">
                     ...
                     <div class="col-lg-3">
                        <div class="icon_box type_two wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                           <h2><a href="prevention-single.html">Tetap di rumah jika anda sakit, dapatkan perawatan medis</a></h2>
                           <div class="icon_box">
                     ...
                     <div class="col-lg-3">
                        <div class="icon_box type_two wow fadeIn" data-wow-delay="0ms" data-wow-duration="1500ms">
                           <h2><a href="prevention-single.html">Tutupi mulut dan hidung anda dengan tisu</a></h2>
                           <div class="icon_box">
                     ...
                     <div class="col-lg-3">
                        <div class="icon_box type_two wow fadeIn" data-wow-delay="500ms" data-wow-duration="1500ms">
                           <h2><a href="prevention-single.html">Segera cuci tangan anda dengan air</a></h2>
                           <div class="icon_box">
                     ...
                     <div class="col-lg-3">
                        <div class="icon_box type_two wow fadeIn" data-wow-delay="600ms" data-wow-duration="1500ms">
                           <h2><a href="prevention-single.html">Jika Anda sakit, anda harus memakai masker</a></h2>
                           <div class="icon_box">
                     ...
                     <div class="col-lg-3">
                        <div class="icon_box type_two wow fadeIn" data-wow-delay="700ms" data-wow-duration="1500ms">
                           <h2><a href="prevention-single.html">Jika permukaannya kotor, bersihkan</a></h2>
                           <div class="icon_box">
                     ...
                     <div class="col-lg-3 col-xs-12">
                        <div class="footer_widgets tp_one first">
                           <h3 class="widgets_title logo">
                              <a href="index.html"><img src="assets/image/home-1-logo.png" class="img-fluid" alt="logo" /></a>
                           </h3>
