                  ...
                  <div class="row">
                     ...
                     <div class="col-lg-6">
                        <div class="heading tp_one  icon_dark">
                           <h6>Tentang Corona</h6>
                           <h1>Coronavirus Disease 2019 (COVID-19)</h1>
                           <span class="flaticon-virus icon"></span>
                        </div>
                        <div class="about_content">
                           <p class="description">Infeksi virus Corona disebut COVID-19 (Corona Virus Disease 2019) dan pertama kali ditemukan di kota Wuhan, China pada akhir Desember 2019. Virus ini menular dengan sangat cepat dan telah menyebar ke hampir semua negara, termasuk Indonesia, hanya dalam waktu beberapa bulan.
                           </p>
                           <div class="symptoms">
                           ...
                           <a href="#" class="theme_btn tp_two">Baca lebih lengkap</a>
                        </div>
                     </div>
                  </div>
               </div>
