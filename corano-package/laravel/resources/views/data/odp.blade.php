      ...
      $(document).ready(function() {
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('odp.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil 
                            ...
                            var oTable = $('#t-odp').dataTable(); //inialisasi datatable
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "odp/" + id, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
