                        ...
                        <div class="container">
                           <div class="table-wrapper">
                              <div class="row">
                                 <div class="col-sm-4">
                                    <!-- Modal Add Form -->
                                    <div class="modal fade" id="addodpmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    ...
                                    <!-- Modal Edit Form -->
                                    <div class="modal fade" id="editodpmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                       <div class="modal-content">
                                          <div class="modal-header">
                                 ...
                                 <button type="button" class="btn btn-info add-new" data-toggle="modal" data-target="#addodpmodal"><i class="fa fa-plus"></i> Add New</button>
                                    </div>
                           ...
                           <div class="table-responsive">
                             <table  class="table table-striped table-bordered" id="t-odp" >
                             <thead>
                                 <tr align="center">
                                    <th>No</th>
                                    <th>Nik</th>
