   ...
   <script type="text/javascript">
      ...
      $(document).ready(function() {
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('sembuh.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil 
                            ...
                            var oTable = $('#t-sembuh').dataTable(); //inialisasi datatable
        ...
        $('body').on('click', '.edit', function () {
            var id = $(this).data('id');
            $.get('sembuh/' + id + '/edit', function (data) {
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "sembuh/" + id, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
