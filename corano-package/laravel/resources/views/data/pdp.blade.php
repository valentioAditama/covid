                     ...
                     <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <div class="container">
                           ...
                           <div class="table-responsive">
                             <table  class="table table-striped table-bordered" id="t-pdp" >
                             <thead>
                                 <tr align="center">
                                    <th>No</th>
                                    <th>Nik</th>
      ...
      $(document).ready(function() {
            ...
            $("#form-tambah-edit").validate({
                submitHandler: function (form) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('pdp.store') }}", //url simpan data
                        ...
                        success: function (data) { //jika berhasil 
                            ...
                            var oTable = $('#t-pdp').dataTable(); //inialisasi datatable
        ...
        $('#tombol-hapus').click(function () {
            $.ajax({
                ...
                url: "pdp/" + id, //eksekusi ajax ke url ini
                type: 'delete',
                beforeSend: function () {
